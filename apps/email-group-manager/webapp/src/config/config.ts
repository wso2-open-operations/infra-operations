...
export const AppConfig = {
  serviceUrls: {
    ...
    userGroups: ServiceBaseUrl + "/email-groups/me",
    allGroups: ServiceBaseUrl + "/email-groups?type=ALL",
    subscribe: ServiceBaseUrl + "/email-group/subscribe",
    unsubscribe: ServiceBaseUrl + "/email-group/unsubscribe",
    defaultGroups: ServiceBaseUrl + "/email-groups?type=DEFAULT",
    publicGroups: ServiceBaseUrl + "/email-groups?type=PUBLIC",
    privateGroups: ServiceBaseUrl + "/email-groups?type=PRIVATE",
  },
};
