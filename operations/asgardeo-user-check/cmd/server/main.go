...
import (
	...
	"github.com/wso2-open-operations/infra-operations/operations/asgardeo-user-check/internal/handler"
	"github.com/wso2-open-operations/infra-operations/operations/asgardeo-user-check/internal/middleware"
...
func main() {
	...
	scimCfg := scim.Config{
		...
		// Scopes is optional; set SCIM_SCOPES as a comma-separated list if required.
	...
	mux.HandleFunc("POST /organizations/external/users/validate", usersHandler.Exists)
	...
	slog.Info("Asgardeo User Check service started", "addr", addr)
	...
	slog.Info("Asgardeo User Check service stopped")
}
